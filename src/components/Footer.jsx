...
export const Footer = () => {
  return (
    ...
    <div className="w-full bg-[#f5f5f7] flex justify-center items-center flex-col py-4">
        ...
        <div className="w-1/2 border-y-[1px] border-gray-500">
            {/* Grid 5 Col */}
            <div className='grid grid-cols-5 gap-3 py-5 self-center '>
                
                <FooterItemColumn section={[footerItems[0], footerItems[5]]} />
                <FooterItemColumn section={[footerItems[1], footerItems[6]]} />
                <FooterItemColumn section={[footerItems[2]]} />
                <FooterItemColumn section={[footerItems[3], footerItems[7], footerItems[9], footerItems[10]]} />
                <FooterItemColumn section={[footerItems[4], footerItems[8]]} />

                
            </div>
            <p className="text-xs text-gray-500 self-center pb-4">More ways to shop: Find an Apple Store or other retailer near you. Or call 1-800-MY-APPLE.</p>
        </div>

        <div className="flex flex-row justify-between w-1/2 pt-6">
            <p className="text-xs text-gray-500 self-center pb-4">Copyright @ 2024 Apple inc. All rights reserved.</p>
            <p className="text-xs text-gray-500 self-center pb-4">Privacy Policy | Terms of Use | Salfes and Refunds | Legal | Site Map</p>
            <p className="text-xs text-gray-500 self-center pb-4">United States</p>
        </div>
